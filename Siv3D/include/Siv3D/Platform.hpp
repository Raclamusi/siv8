...
# define SIV3D_CPU_PRIVATE_DEFINITION_WASM32()		0
...
# elif defined(__wasm32__) // WebAssembly 32-bit

	# define SIV3D_CPU_ARCHITECTURE	U"WebAssembly 32-bit"
	# undef	 SIV3D_CPU_PRIVATE_DEFINITION_WASM32
	# define SIV3D_CPU_PRIVATE_DEFINITION_WASM32()	1
...
# define SIV3D_INTRINSIC_PRIVATE_DEFINITION_WASM_SIMD128()	0
...
# elif defined(__wasm_simd128__) // WebAssembly SIMD を利用できる

	# define SIV3D_INTRINSIC_TYPE	U"WebAssembly SIMD"
	# undef  SIV3D_INTRINSIC_PRIVATE_DEFINITION_WASM_SIMD128
	# define SIV3D_INTRINSIC_PRIVATE_DEFINITION_WASM_SIMD128()	1
